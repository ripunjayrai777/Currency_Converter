package com.lcwd.currencyconverter;
...
import com.lcwd.currencyconverter.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
   ...
   private List<String> units = Arrays.asList(
    ...
    // Contain the logic to convert the currencies.
    private void convertValue() {
        try {
            ...
            //yaha par baki ke sare logic build karna hai uper se eles if vala copy karke
